...
// console.log(createMenuItem('Sandwich', 1, "Lunch"));
// console.log(latte);

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
console.log(createMenuItem('Sandwich', 3, "Lunch"));
console.log(createMenuItem('Bagel', 1, "Breakfast"));
console.log(createMenuItem('Strawberry Smoothie', 4, "Drinks"));
...
function addReview(name, rating, feedback) {
  const toAdd = { name, rating, feedback };
  reviews.push(toAdd);
  return reviews;
}

console.log(addReview('Reyna', 5, 'I like the restaurant!'));
